...
const GetStartInFree = () => {
  return (
    <section className="relative mx-auto flex w-full max-w-6xl flex-col items-start gap-6 px-4 py-12 md:gap-12 md:py-24 xl:pe-4 xl:ps-0 mt-8 md:mt-0">
        ...
        <span className="text-neutral-800"> looks great </span>
        but also
        <span className="text-neutral-800"> engages your audience</span>
        </p>
        <Link href="" className="relative inline-flex w-fit items-center justify-center gap-1 whitespace-nowrap rounded-xl bg-neutral-900 px-4 py-2.5 text-md font-semibold leading-6 tracking-[-0.3px] text-white transition-colors hover:bg-neutral-800 md:px-6 md:py-3 md:text-lg">
